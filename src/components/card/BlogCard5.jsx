...
function BlogCard5() {
    return (
       ...
       {/* <!-- REST OF THE CARDS --> */}
        ...
        {/* <!-- CARD-3 --> */}
        <Link to="featuring a video.html" class="main-card main-card-1">
          <img src= {blog3} alt="" class="main-card-img"/>
          <img src={avatar1} alt="" class="card-avatar-1"/>
          <h2 class="tips-card">Tips</h2>
        ...
        {/* <!-- CARD-4 --> */}
        <Link to="getting started.html" class="main-card main-card-4">
          <img src= {blog4} alt="" class="main-card-img"/>
          <img src= {avatar1} alt="" class="card-avatar-1"/>
          <h2 class="tips-card">Tips</h2>
  
          <div><h5>Customizing your page 	&#127912;</h5></div>
     ...
     {/* <!-- CARD-7 --> */}
      ...
      <Link to="getting started.html" className="main-card main-card-10">
        ...
        <Link to="featuring a video.html" className="main-card main-card-12">
          ...
          <h2 className="tips-card">Tips</h2>
          <div><h5>Building your email list&#127969;.</h5></div>
              <div><h6>6 months ago &nbsp;&bull;&nbsp;<span>&nbsp;2 mins read</span></h6></div>s
          </Link>
